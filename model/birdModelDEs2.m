...
gamma = importdata('move_per_capita.csv'); % An n x n matrix.  The (i,j) entry represents the rate with which birds migrate from patch i to patch j.  These values depend on the connectivity between patches
